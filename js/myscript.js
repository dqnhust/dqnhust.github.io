...
function getHTMLContent(name, videoURL, platform, description, buttons) {
  ...
  return '<div class="row">    <div class="col-md-7"> <center background-color="#444444">       <video src = "'+videoURL+'" controls> </video>    </center></div>    <div class="col-md-5">        <h3>'+name+'</h3>        <h4>'+platform+'</h4>        <p>'+description+'</p>      '+buttonsHTML+'   </div></div><hr>';
}